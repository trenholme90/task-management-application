...
routes.patch(
	'/dashboard/group/:id/board/:boardId/edit',
	BoardController.editBoard
)
routes.delete(
	'/dashboard/group/:id/board/:boardId',
...
routes.post(
	'/dashboard/group/:id/board/:boardId/task/create',
	TaskController.createTask
)
routes.get(
	'/dashboard/group/:id/board/:boardId/task/:taskId',
